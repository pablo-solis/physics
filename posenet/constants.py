...
## PART OF THE SHRED PROJECT
# format joint: (end1,end2)
# the angle of the joint is formed from the vector (joint, end1), (joint, end2)
JOINT_MAP_NAMES = {
...
TORSO = [('leftHip', 'leftShoulder'),('rightHip', 'rightShoulder')]

JOINT_MAP_INDEX = {PART_IDS[k]:(PART_IDS[v[0]],PART_IDS[v[1]]) for k,v in JOINT_MAP_NAMES.items()}
